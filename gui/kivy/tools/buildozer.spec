...
source.exclude_dirs = bin, build, dist, contrib, gui/qt, gui/kivy/tools, gui/kivy/theming/light,pyopenssl
...
requirements = python3crystax, android, plyer, kivy==master
...
android.ndk_path = /home/wszyscy/.buildozer/crystax-ndk-10.3.2
...
android.whitelist = lib-dynload/_csv.so,lib-dynload/_ssl.so

# local version that merges branch 866
#p4a.source_dir = /home/wszyscy/.buildozer/python-for-android/
